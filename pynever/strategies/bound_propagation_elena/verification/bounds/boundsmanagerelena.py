...
from pynever.strategies.bound_propagation_elena.verification.bounds.bounds import SymbolicLinearBounds, HyperRectangleBounds
    ...
    def compute_bounds(self):
        ...
        for i in range(0, len(layers)):
            ...
            if isinstance(layers[i], pynever.strategies.abstraction.AbsReLUNode):
                symbolic_activation_output_bounds = self.compute_relu_output_bounds(layers[i + 1],
                                                                                    symbolic_dense_output_bounds,
                                                                                    input_hyper_rect)
                ...
                #layers[i].previous_layer_symb_post_bounds = last_layer_bound
