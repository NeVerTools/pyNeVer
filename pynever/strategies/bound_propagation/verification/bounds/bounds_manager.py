...
from pynever.strategies.bound_propagation.verification.bounds.bounds import SymbolicLinearBounds, \
    HyperRectangleBounds
from pynever.strategies.bound_propagation.verification.bounds.linearfunctions import LinearFunctions
from pynever.strategies.bound_propagation.utils.utils import get_positive_part, get_negative_part, \
    compute_lin_lower_and_upper
from pynever.strategies.bound_propagation.utils.property_converter import *
from collections import OrderedDict
import numpy as np


class BoundsManager_2:
