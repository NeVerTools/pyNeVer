...
class ConvFunctions:
    ...
    def initialise_im2col_indices(self, conv_node: ConvNode):
        ...
        self.k, self.i, self.j = ConvFunctions.get_im2col_indices(
    ...
    def _get_input_col(self, conv_node: ConvNode, inputs):
        ...
        input_col = ConvFunctions.im2col_indices(inputs, h_filter, w_filter,
    ...
    def im2col_indices(x, field_height, field_width, padding=1, stride=1):
        ...
        k, i, j = ConvFunctions.get_im2col_indices(x.shape, field_height, field_width, padding, stride)
    ...
    def _get_input_col_opt(self, conv_node: ConvNode, inputs):
        ...
        input_col = self.im2col_indices_opt(self, inputs, h_filter, w_filter,
                                            padding=conv_node.padding[0],
                                            stride=conv_node.stride[0])
        return input_col
