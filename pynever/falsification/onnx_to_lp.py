...
# network, and writes a MILP problem which checks if the property on the output is satisfied given that on the input

NETWORK_PATH = "ex.onnx"
PROPERTY_PATH = "ex.smt2"
NETWORK_NAME = NETWORK_PATH.split(".")[0]
