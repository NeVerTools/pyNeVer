...
prop.from_smt_file('../../../examples/benchmarks/ACAS XU/Properties/prop_2.vnnlib')

onnx_nn = conversion.load_network_path('../../../examples/benchmarks/ACAS XU/Networks/ACAS_XU_3_5.onnx')
