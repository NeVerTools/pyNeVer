...
if __name__ == '__main__':
    ...
    # verification_parameters = [["best_n_neurons", [[0] for _ in range(6)]],
    #                            ["best_n_neurons", [[1] for _ in range(6)]]]
    #
    # param_set_id = ["Over-Approx", "Mixed", "Complete"]

    verification_parameters = [["best_n_neurons", [[10000] for _ in range(6)]]]
